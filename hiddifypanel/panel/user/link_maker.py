...
def add_singbox_wireguard(base, proxy):
    ...
    base["mtu"] = 1380
    if g.user_agent.get('is_hiddify') and g.user_agent.get('hiddify_version') and len(g.user_agent.get('hiddify_version')) > 1 and g.user_agent.get('hiddify_version')[1] > 14:
