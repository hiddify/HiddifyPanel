...
def proxy_info(name, port=443, security="tls"):
    x=proxy_info2(name)
    return x
def proxy_info2(name, port=443, security="tls"):
    domain = g.domain
